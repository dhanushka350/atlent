...
<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
    ...
    <!-- SIGN OUT -->
    <%--<li class="">--%>
    <%--<a href="#" class="mb-control"><span class="fa fa-smile-o"></span></a>--%>
    <%--</li>--%>
    <li class="xn-icon-button pull-right">
        <a class="mb-control" data-box="#mb-signout"><span class="fa fa-sign-out"></span></a>
    </li>
    <!-- END SIGN OUT -->
    <!-- MESSAGES -->
    <li class="xn-icon-button pull-right">
        ...
        <%--<img src="/assets/images/users/userDto.jpg" class="pull-left" alt="Dmitry Ivaniuk"/>--%>
